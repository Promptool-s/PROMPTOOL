...
const PROMPTS = {
  es: [
    ...
    'Gato gris mirando el cielo estrellado, Vía Láctea y nebulosa violeta, fotografía nocturna',
  ...
  en: [
    ...
    'Grey cat gazing at the starry sky, Milky Way and violet nebula, night photography',
