...
export const copy = {
  es: {
    ...
    heroLab: {
      ...
      blocks: [
        { k: 'Sujeto', v: 'gato gris y blanco, mirada hacia arriba' },
        { k: 'Escena', v: 'cielo estrellado, Vía Láctea, estrella fugaz' },
        { k: 'Iluminación', v: 'nebulosa rosada y violeta, contraluz suave' },
        { k: 'Cámara', v: '35 mm, f/1.8, plano contrapicado nocturno' },
  ...
  en: {
    ...
    heroLab: {
      ...
      blocks: [
        { k: 'Subject', v: 'grey and white cat, gazing upward' },
        { k: 'Scene', v: 'starry sky, Milky Way, shooting star' },
        { k: 'Lighting', v: 'pink and violet nebula, soft backlight' },
        { k: 'Camera', v: '35 mm, f/1.8, low-angle night shot' },
