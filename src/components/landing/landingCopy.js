...
export const copy = {
  es: {
    ...
    sceneDescription: 'Fondo decorativo animado en 3D con paneles luminosos que acompañan cada sección.',
    scrollDown: 'Bajar',
  ...
  en: {
    ...
    sceneDescription: 'Decorative animated 3D background with glowing panels that follow each section.',
