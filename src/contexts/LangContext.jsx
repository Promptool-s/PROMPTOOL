...
const translations = {
  es: {
    ...
    promptPlaceholder: 'Describí la escena: sujeto, entorno, estilo artístico, iluminación (golden hour, rim light), términos técnicos (4K, bokeh, cinematic)…',
    promptRecommendation: 'Suma términos técnicos de IA (bokeh, HDR, cinematic, golden hour) para subir el score.',
  ...
  en: {
    ...
    promptPlaceholder: 'Describe the scene: subject, environment, art style, lighting (golden hour, rim light), technical terms (4K, bokeh, cinematic)…',
    promptRecommendation: 'Add AI technical terms (bokeh, HDR, cinematic, golden hour) to boost your score.',
